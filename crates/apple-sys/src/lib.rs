...
#[cfg(all(target_os = "macos", feature = "ARKit"))]
pub mod ARKit {
...
#[cfg(all(target_os = "macos", feature = "BrowserEngineCore"))]
pub mod BrowserEngineCore {
    include!(concat!(env!("OUT_DIR"), "/BrowserEngineCore.rs"));
}
#[cfg(all(target_os = "macos", feature = "BrowserEngineKit"))]
pub mod BrowserEngineKit {
    include!(concat!(env!("OUT_DIR"), "/BrowserEngineKit.rs"));
}
...
#[cfg(all(target_os = "macos", feature = "Cinematic"))]
pub mod Cinematic {
    include!(concat!(env!("OUT_DIR"), "/Cinematic.rs"));
}
...
#[cfg(all(target_os = "macos", feature = "CompositorServices"))]
pub mod CompositorServices {
    include!(concat!(env!("OUT_DIR"), "/CompositorServices.rs"));
}
...
#[cfg(all(target_os = "macos", feature = "DeviceDiscoveryExtension"))]
...
pub mod FSKit {
    include!(concat!(env!("OUT_DIR"), "/FSKit.rs"));
}
...
#[cfg(all(target_os = "macos", feature = "GameSave"))]
pub mod GameSave {
    include!(concat!(env!("OUT_DIR"), "/GameSave.rs"));
}
...
#[cfg(all(target_os = "macos", feature = "MediaExtension"))]
pub mod MediaExtension {
    include!(concat!(env!("OUT_DIR"), "/MediaExtension.rs"));
}
...
#[cfg(all(target_os = "macos", feature = "MetalPerformancePrimitives"))]
pub mod MetalPerformancePrimitives {
    include!(concat!(env!("OUT_DIR"), "/MetalPerformancePrimitives.rs"));
}
...
#[cfg(all(target_os = "macos", feature = "SecurityUI"))]
pub mod SecurityUI {
    include!(concat!(env!("OUT_DIR"), "/SecurityUI.rs"));
}
#[cfg(all(target_os = "macos", feature = "SensitiveContentAnalysis"))]
pub mod SensitiveContentAnalysis {
    include!(concat!(env!("OUT_DIR"), "/SensitiveContentAnalysis.rs"));
}
...
#[cfg(all(target_os = "macos", feature = "StickerKit"))]
pub mod StickerKit {
    include!(concat!(env!("OUT_DIR"), "/StickerKit.rs"));
}
...
#[cfg(all(target_os = "macos", feature = "Symbols"))]
pub mod Symbols {
...
#[cfg(all(target_os = "ios", feature = "AccessorySetupKit"))]
pub mod AccessorySetupKit {
    include!(concat!(env!("OUT_DIR"), "/AccessorySetupKit.rs"));
}
...
#[cfg(all(target_os = "ios", feature = "Assignables"))]
pub mod Assignables {
    include!(concat!(env!("OUT_DIR"), "/Assignables.rs"));
}
...
#[cfg(all(target_os = "ios", feature = "BrowserEngineCore"))]
pub mod BrowserEngineCore {
    include!(concat!(env!("OUT_DIR"), "/BrowserEngineCore.rs"));
}
#[cfg(all(target_os = "ios", feature = "BrowserEngineKit"))]
pub mod BrowserEngineKit {
    include!(concat!(env!("OUT_DIR"), "/BrowserEngineKit.rs"));
}
#[cfg(all(target_os = "ios", feature = "BrowserKit"))]
pub mod BrowserKit {
    include!(concat!(env!("OUT_DIR"), "/BrowserKit.rs"));
}
...
#[cfg(all(target_os = "ios", feature = "Cinematic"))]
pub mod Cinematic {
    include!(concat!(env!("OUT_DIR"), "/Cinematic.rs"));
}
...
#[cfg(all(target_os = "ios", feature = "DeviceDiscoveryUI"))]
...
#[cfg(all(target_os = "ios", feature = "GameSave"))]
pub mod GameSave {
    include!(concat!(env!("OUT_DIR"), "/GameSave.rs"));
}
...
#[cfg(all(target_os = "ios", feature = "LockedCameraCapture"))]
pub mod LockedCameraCapture {
    include!(concat!(env!("OUT_DIR"), "/LockedCameraCapture.rs"));
}
...
#[cfg(all(target_os = "ios", feature = "MetalPerformancePrimitives"))]
pub mod MetalPerformancePrimitives {
    include!(concat!(env!("OUT_DIR"), "/MetalPerformancePrimitives.rs"));
}
...
#[cfg(all(target_os = "ios", feature = "SecurityUI"))]
pub mod SecurityUI {
    include!(concat!(env!("OUT_DIR"), "/SecurityUI.rs"));
}
#[cfg(all(target_os = "ios", feature = "SensitiveContentAnalysis"))]
pub mod SensitiveContentAnalysis {
    include!(concat!(env!("OUT_DIR"), "/SensitiveContentAnalysis.rs"));
}
...
#[cfg(all(target_os = "ios", feature = "ServicesAccountLinking"))]
pub mod ServicesAccountLinking {
    include!(concat!(env!("OUT_DIR"), "/ServicesAccountLinking.rs"));
}
...
#[cfg(all(target_os = "ios", feature = "StickerKit"))]
pub mod StickerKit {
    include!(concat!(env!("OUT_DIR"), "/StickerKit.rs"));
}
...
#[cfg(all(target_os = "ios", feature = "Symbols"))]
pub mod Symbols {
    include!(concat!(env!("OUT_DIR"), "/Symbols.rs"));
}
...
#[cfg(all(target_os = "ios", feature = "SystemExtensions"))]
pub mod SystemExtensions {
    include!(concat!(env!("OUT_DIR"), "/SystemExtensions.rs"));
}
...
#[cfg(all(target_os = "ios", feature = "TouchController"))]
pub mod TouchController {
    include!(concat!(env!("OUT_DIR"), "/TouchController.rs"));
}
#[cfg(all(target_os = "ios", feature = "TranslationUIProvider"))]
pub mod TranslationUIProvider {
    include!(concat!(env!("OUT_DIR"), "/TranslationUIProvider.rs"));
}
