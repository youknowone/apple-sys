...
impl std::convert::TryFrom<NSObject> for SFSafariExtensionViewController {
    type Error = &'static str;
    fn try_from(parent: NSObject) -> Result<SFSafariExtensionViewController, Self::Error> {
        ...
        if is_kind_of {
            ...
            Err("This NSObject cannot be downcasted to SFSafariExtensionViewController")
        }
    }
}
