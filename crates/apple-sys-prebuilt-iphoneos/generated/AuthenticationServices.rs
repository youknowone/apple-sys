...
unsafe extern "C" {
    pub static ASExtensionLocalizedFailureReasonErrorKey: NSErrorUserInfoKey;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub static ASGeneratedPasswordKindStrong: ASGeneratedPasswordKind;
}
unsafe extern "C" {
    pub static ASGeneratedPasswordKindAlphanumeric: ASGeneratedPasswordKind;
}
unsafe extern "C" {
    pub static ASGeneratedPasswordKindPassphrase: ASGeneratedPasswordKind;
}
unsafe extern "C" {
